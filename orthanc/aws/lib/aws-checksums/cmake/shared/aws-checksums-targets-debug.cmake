...
set_target_properties(AWS::aws-checksums PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libaws-checksums.so"
  IMPORTED_SONAME_DEBUG "libaws-checksums.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS AWS::aws-checksums )
list(APPEND _IMPORT_CHECK_FILES_FOR_AWS::aws-checksums "${_IMPORT_PREFIX}/lib/libaws-checksums.so" )
